"""YOLACT training target generator."""
...
class YOLACTTargetGenerator(Block):
    ...
    def __init__(self, iou_thresh=0.5, neg_thresh=0.5, negative_mining_ratio=3,
        ...
        super(YOLACTTargetGenerator, self).__init__(**kwargs)
    ...
    def forward(self, anchors, cls_preds, gt_boxes, gt_ids):
        ...
        return cls_targets, box_targets, matches
